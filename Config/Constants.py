class Constants:
    ...
    INPUT_POPS_SHP_2018 = SOURCE_DATA_PATH + 'JRC_POPULATION_2018.shp'
    ...
    OUTPUT_POP_2018 = 'POP_2018_GRID.shp'
    OUTPUT_POP_CHANGES = 'POP_GRID_FINAL.shp'
    OUTPUT_POP_CHANGES_FIELD_1 = 'POP_06_11'
    OUTPUT_POP_CHANGES_FIELD_2 = 'POP_11_18'
    INPUT_GRID_CSV_2006_FIELD = 'GRD_INSPIR'
    INPUT_GRID_CSV_2011_FIELD = 'GRD_ID'
    INPUT_GRID_2018_FIELD = 'TOT_P_2018'
    ...
    OUTPUT_PREDICTION_CORINE_CSV1 = 'ml_data\\predict_corine_seq.csv'
    OUTPUT_PREDICTION_CORINE_CSV2 = 'ml_data\\predict_corine_rf.csv'
